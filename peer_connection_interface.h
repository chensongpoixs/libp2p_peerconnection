...
namespace libp2p_peerconnection {
	...
	public:
		...
		virtual libmedia_transfer_protocol::MediaStreamInterface* at(size_t index) = 0;
		virtual libmedia_transfer_protocol::MediaStreamInterface* find(const std::string& label) = 0;
		virtual libmedia_transfer_protocol::MediaStreamTrackInterface* FindAudioTrack(const std::string& id) = 0;
		virtual libmedia_transfer_protocol::MediaStreamTrackInterface* FindVideoTrack(const std::string& id) = 0;
	...
	public:
		virtual void OnComplete(const webrtc::StatsReports& reports) = 0;
...
public:
	...
	struct   RTCConfiguration {
		...
		int max_ipv6_networks = libice::kDefaultMaxIPv6Networks;
		...
		struct libmedia_transfer_protocol::MediaConfig media_config;
...
*/
		...
		absl::optional<libmedia_transfer_protocol::CryptoOptions> crypto_options;
	...
	// This method is not supported with kUnifiedPlan semantics. Please use
	// AddTrack instead.
//	virtual bool AddStream(libmeia_transfer_protocol::MediaStreamInterface* stream) = 0;
	...
	// This method is not supported with kUnifiedPlan semantics. Please use
	// RemoveTrack instead.
	//virtual void RemoveStream(libmeia_transfer_protocol::MediaStreamInterface* stream) = 0;
...
//	virtual webrtc::RTCErrorOr<rtc::scoped_refptr<RtpSenderInterface>> AddTrack(
...
//			const RtpTransceiverInit& init) = 0;
	...
	//virtual webrtc::RTCError SetConfiguration(
	...
	//// signature.
	//virtual bool AddIceCandidate(const libice::IceCandidateInterface* candidate) = 0;
