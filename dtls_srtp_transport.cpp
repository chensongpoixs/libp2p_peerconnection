...
bool DtlsSrtpTransport::IsDtlsConnected() {
  ...
  return (rtp_dtls_transport_ &&
          rtp_dtls_transport_->dtls_state() == libice::DtlsTransportState::kConnected &&
...
void DtlsSrtpTransport::SetDtlsTransport(
    libice::DtlsTransportInternal* new_dtls_transport,
  ...
  if (new_dtls_transport) {
    new_dtls_transport->SubscribeDtlsTransportState(
        ...
        [this](libice::DtlsTransportInternal* transport,
			libice::DtlsTransportState state) { OnDtlsState(transport, state); });
  }
}
...
void DtlsSrtpTransport::OnDtlsState(libice::DtlsTransportInternal* transport,
  ...
  if (state != libice::DtlsTransportState::kConnected) {
    ResetParams();
    return;
  }
