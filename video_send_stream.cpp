...
//VideoSendStream::Config::Config(libmedia_transfer_protocol::Transport* send_transport)
//    : rtp(),
//      encoder_settings(libmedia_codec::VideoEncoder::Capabilities(rtp.lntf.enabled)),
