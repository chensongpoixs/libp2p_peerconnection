...
#ifndef _C_PC_SRTP_TRANSPORT_H_
#define _C_PC_SRTP_TRANSPORT_H_
...
class SrtpTransport : public RtpTransport {
 public:
  ...
  virtual webrtc::RTCError SetSrtpSendKey(const cricket::CryptoParams& params);
  virtual webrtc::RTCError SetSrtpReceiveKey(const cricket::CryptoParams& params);
