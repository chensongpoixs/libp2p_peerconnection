...
#ifndef  _C_PC_RTP_TRANSPORT_INTERNAL_H_
#define _C_PC_RTP_TRANSPORT_INTERNAL_H_
...
class RtpTransportInternal : public sigslot::has_slots<> {
 public:
  ...
  virtual void UpdateRtpHeaderExtensionMap(
      const libp2p_peerconnection::RtpHeaderExtensions& header_extensions) = 0;

  virtual bool IsSrtpActive() const = 0;

  virtual bool RegisterRtpDemuxerSink(const webrtc::RtpDemuxerCriteria& criteria,
